...
const (
	...
	BackAllowlistEnforcementMode = "allowlist-enforcement-mode"
	...
	BackDenylistEnforcementMode  = "denylist-enforcement-mode"
	...
	BackPeersTable               = "peers-table"
	BackProxyBodySize            = "proxy-body-size"
	BackProxyProtocol            = "proxy-protocol"
	BackRedirectTo               = "redirect-to"
	BackRequestAddHeaders        = "request-add-headers"
	BackRequestDelHeaders        = "request-del-headers"
	BackRequestSetHeaders        = "request-set-headers"
	BackResponseAddHeaders       = "response-add-headers"
	BackResponseDelHeaders       = "response-del-headers"
	BackResponseSetHeaders       = "response-set-headers"
