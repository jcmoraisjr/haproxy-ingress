...
| `affinity`                | `Backend` |         |       |
| `coookie-key`             | `Global`  |         |       |
| `session-cookie-dynamic`  | `Backend` |         |       |
| `session-cookie-name`     | `Backend` |         |       |
| `session-cookie-strategy` | `Backend` |         |       |
...
* `session-cookie-dynamic`: indicates whether or not dynamic cookie naming will be used. With the
