...
HAProxy Ingress configuration keys may be in one of four distinct scopes. A scope
...
conflicting.
* Scope `Path`: Defines configuration keys that bind to the hostname and the HTTP path.
