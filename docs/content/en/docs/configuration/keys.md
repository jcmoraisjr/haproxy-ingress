...
| [`waf-fail-closed`](#waf)                            | [true\|false]                           | Path    | `false`            |
...
|-------------------|--------|---------|-------|
| `waf`             | `Path` |         |       |
| `waf-fail-closed` | `Path` | `false` | v0.14 |
...
cause the request to be denied ("true") or allowed ("false"). The default value is "false" for backwards compatibility.
